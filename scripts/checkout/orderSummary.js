import {cart, removeFromCart, removeOneFromCart, updateDeliveryOption} from '../../data/cart.js';
...
export function renderOrderSummary() {
  ...
  cart.forEach((cartItem) => {
    ...
    if (matchingProduct) {
      // Access matchingProduct.id safely
      const productId = matchingProduct.id;
      // ... rest of the code
    } else {
      console.error("matchingProduct is undefined");
    }
        ...
        <div class="cart-item-details-grid">
          ...
          <div class="cart-item-details">
            ...
            ">
              ...
              <span class="delete-all-quantity-link link-primary js-delete-all-link 
              js-delete-all-link-${matchingProduct.id}" 
  ...
  document.querySelectorAll('.js-delete-all-link')
    .forEach((link) => {
      link.addEventListener('click', () => {
        const productId = link.dataset.productId;
